  ...
  return (
    <>
      ...
      <P>
        ...
        components. The combined components provide the <code>layout</code> prop
        for setting what kind of layout components the subcomponents are wrapped
        in. It accepts the following values: <code>grid</code>,{' '}
      ...
      <P>
        With the <code>grid</code> and <code>grid2</code> options the combined
