...
export default function Customization() {
  return (
    <>
      ...
      <P>
        The combined country code selector components can be customized by
        ...
        combined components. The <code>selectorProps</code> accepts all of the
        MUI{' '}
        <A href="https://mui.com/material-ui/react-autocomplete/" newTab>
          Autocomplete&apos;s
        </A>{' '}
        props, except <code>onChange</code>, <code>options</code> and{' '}
        <code>value</code>. These properties are controlled by the combined
      ...
      <P>
        ...
        applied to a <code>CountryCodeSelectorCombined</code> component.
      </P>
